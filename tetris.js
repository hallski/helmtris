...
var _user$project$Grid$width = function (_p0) {
	...
	var maximumWithDefault = function ($default) {
		return function (_p2) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				$default,
				_elm_lang$core$List$maximum(_p2));
		};
	};
	var rowWidth = function (_p3) {
		return A2(
			maximumWithDefault,
			0,
	...
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$map, rowWidth, _p1._0)));
};
var _user$project$Grid$height = function (_p4) {
	var _p5 = _p4;
	return _elm_lang$core$List$length(_p5._0);
};
var _user$project$Grid$detectCollision = F3(
	function (yOffset, _p7, _p6) {
		var _p8 = _p7;
		var _p9 = _p6;
		...
		while (true) {
			...
			if (_p10.ctor === '[]') {
				...
				var renderedCell = A2(
					...
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$toFloat(_p10._0._0 * _user$project$Grid$cellSize),
						_1: 0
					},
					A2(
...
var _user$project$Grid$empty = function (rows) {
...
var _user$project$Grid$fromListsOfCells = function (list) {
	return _user$project$Grid$Grid(list);
};
var _user$project$Grid$padGrid = F2(
	function (nr, _p14) {
		padGrid:
		while (true) {
			var _p15 = _p14;
			...
			var _p16 = nr;
			if (_p16 === 0) {
				return _user$project$Grid$Grid(_p17);
			} else {
				var _v15 = _p16 - 1,
					_v16 = _user$project$Grid$Grid(
					{
						ctor: '::',
						_0: {ctor: '[]'},
						_1: _p17
...
var _user$project$Grid$removeFullRows = F2(
	function (fullWidth, _p18) {
		var _p19 = _p18;
		var _p20 = _p19._0;
		var newGrid = A2(
			...
			_p20);
		var removed = _elm_lang$core$List$length(_p20) - _elm_lang$core$List$length(newGrid);
		return {
			ctor: '_Tuple2',
			_0: removed,
			_1: A2(
				_user$project$Grid$padGrid,
				removed,
				_user$project$Grid$Grid(newGrid))
		};
	});
var _user$project$Grid$copyOnto = F3(
	function (yOffset, _p22, _p21) {
		var _p23 = _p22;
		var _p26 = _p23._0;
		var _p24 = _p21;
		var _p25 = _p24._0;
		var fromBlockRows = A2(_elm_lang$core$List$drop, yOffset, _p25);
		var aboveRows = A2(_elm_lang$core$List$take, yOffset, _p25);
		var sourceHeight = _elm_lang$core$List$length(_p26);
		var belowRows = A2(_elm_lang$core$List$drop, sourceHeight, fromBlockRows);
		var replacedRows = A3(
			_elm_lang$core$List$map2,
			_elm_lang$core$List$append,
			_p26,
			A2(_elm_lang$core$List$take, sourceHeight, fromBlockRows));
		return _user$project$Grid$Grid(
			_elm_lang$core$List$concat(
				{
					ctor: '::',
...
var _user$project$Grid$mapCells = F2(
	function (fn, _p27) {
		...
		return _user$project$Grid$Grid(
			A2(_elm_lang$core$List$map, mapCellsInRow, _p28._0));
	});
var _user$project$Grid$rotate = function (_p29) {
	var _p30 = _p29;
	var _p33 = _p30._0;
	var maybeMapYToX = F2(
		function (row, _p31) {
			var _p32 = _p31;
			return _elm_lang$core$Native_Utils.eq(row, _p32._0._0) ? _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: _p32._0._1, _1: _p32._1}) : _elm_lang$core$Maybe$Nothing;
		});
	...
	var newGrid = A2(
		...
		A2(
			_elm_lang$core$List$range,
			0,
			_user$project$Grid$width(
				_user$project$Grid$Grid(_p33)) - 1));
	return _user$project$Grid$Grid(newGrid);
};
...
var _user$project$Block$move = F4(
	function (minX, maxX, dx, _p7) {
		var _p8 = _p7;
		var _p9 = _p8._0;
		var maxStartX = maxX - _user$project$Grid$width(_p9.grid);
		var newX = A3(_elm_lang$core$Basics$clamp, minX, maxStartX, _p9.x + dx);
		return _user$project$Block$Block(
			_elm_lang$core$Native_Utils.update(
				_p9,
				{x: newX}));
	});
var _user$project$Block$moveY = F2(
	function (dy, _p10) {
		var _p11 = _p10;
		var _p12 = _p11._0;
		return _user$project$Block$Block(
...
var _user$project$Block$rotate = function (_p13) {
	var _p14 = _p13;
	var _p15 = _p14._0;
	return _user$project$Block$Block(
		_elm_lang$core$Native_Utils.update(
			_p15,
			{
				grid: _user$project$Grid$rotate(_p15.grid)
			}));
};
	...
	function (_p16, grid) {
		...
		return A3(
			...
			_user$project$Block$toGrid(
				_user$project$Block$Block(_p18)),
			grid);
	});
...
var _user$project$Main$clampedMoveBlock = A2(_user$project$Block$move, 0, _user$project$Main$playFieldSize.cols);
var _user$project$Main$updateActiveBlock = F2(
	function (model, time) {
		if (_elm_lang$core$Native_Utils.cmp(time, model.nextDrop) < 0) {
			return model;
		} else {
			var interval = model.boost ? 50 : 200;
			var nextDrop = time + (interval * _elm_lang$core$Time$millisecond);
			var block = model.activeBlock;
			var proposedBlock = A2(_user$project$Block$moveY, 1, block);
			if (A2(_user$project$Block$detectCollisionInGrid, proposedBlock, model.landed)) {
				var landed = A2(_user$project$Block$copyOntoGrid, block, model.landed);
				var _p0 = A2(_user$project$Grid$removeFullRows, _user$project$Main$playFieldSize.cols, landed);
				var removed = _p0._0;
				var newLanded = _p0._1;
				var _p1 = _user$project$Block$getRandom(model.seed);
				var seed = _p1._0;
				var newActive = _p1._1;
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{activeBlock: proposedBlock, nextDrop: nextDrop});
			}
		}
	});
...
var _user$project$Main$init = function () {
	var grid = _user$project$Grid$empty(_user$project$Main$playFieldSize.rows);
	var _p2 = _user$project$Block$getRandom(
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$updateActiveBlock, model, _p3._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TogglePlay':
				return {
			...
			case 'Left':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							activeBlock: A2(_user$project$Main$clampedMoveBlock, -1, model.activeBlock)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Right':
			...
			case 'Rotate':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							activeBlock: _user$project$Block$rotate(model.activeBlock)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Boost':
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["Time.Time"],"Left":[],"Boost":["Bool"],"Reset":[],"Right":[],"NoOp":[],"TogglePlay":[],"Rotate":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}

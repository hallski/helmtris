...
var _user$project$Grid$width = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Grid$height = function (_p2) {
	var _p3 = _p2;
	return _p3._1;
};
var _user$project$Grid$detectCollision = F3(
	function (yOffset, _p5, _p4) {
		var _p6 = _p5;
		var _p7 = _p4;
		var findCollisionsInRows = F2(
			function (blockRow, landedRow) {
				var landedXs = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, landedRow);
				var blockXs = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, blockRow);
				return A2(
					_elm_lang$core$List$any,
					_elm_lang$core$Basics$identity,
					A2(
						_elm_lang$core$List$map,
						A2(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, blockXs),
						landedXs));
			});
		var stopRow = A2(
			_elm_lang$core$List$map,
		...
		return A2(
			...
			A3(
				_elm_lang$core$List$map2,
				findCollisionsInRows,
				_p6._2,
				A2(_elm_lang$core$List$drop, yOffset, gridWithStop)));
	});
var _user$project$Grid$cellSize = 25;
var _user$project$Grid$renderLine = F2(
		...
		while (true) {
			...
			if (_p8.ctor === '[]') {
				...
				var renderedCell = A2(
					...
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$toFloat(_p8._0._0 * _user$project$Grid$cellSize),
						_1: 0
					},
					A2(
						...
						A2(
							...
							_elm_lang$core$Basics$toFloat(_user$project$Grid$cellSize),
							_elm_lang$core$Basics$toFloat(_user$project$Grid$cellSize))));
				var _v5 = _p8._1,
					_v6 = {ctor: '::', _0: renderedCell, _1: rendered};
				line = _v5;
				rendered = _v6;
				continue renderLine;
			}
...
var _user$project$Grid$renderLines = F4(
	function (xOffset, yOffset, lines, rendered) {
		renderLines:
		while (true) {
			var _p9 = lines;
			if (_p9.ctor === '[]') {
				...
				var renderedLine = A2(
					...
					A2(_evancz$elm_graphics$Transform$translation, xOffset, yOffset),
					A2(
						_user$project$Grid$renderLine,
						_p9._0,
						{ctor: '[]'}));
				var _v8 = xOffset,
					_v9 = yOffset + _elm_lang$core$Basics$toFloat(_user$project$Grid$cellSize),
					_v10 = _p9._1,
					_v11 = {ctor: '::', _0: renderedLine, _1: rendered};
				xOffset = _v8;
				yOffset = _v9;
				lines = _v10;
				rendered = _v11;
				continue renderLines;
			}
		}
	});
var _user$project$Grid$render = F3(
	function (xOffset, yOffset, _p10) {
		var _p11 = _p10;
		return _evancz$elm_graphics$Collage$group(
			A4(
				_user$project$Grid$renderLines,
				xOffset,
				yOffset,
				_p11._2,
				{ctor: '[]'}));
...
var _user$project$Grid$empty = F2(
	function (cols, rows) {
		return A3(
...
var _user$project$Grid$fromListsOfCells = function (list) {
	var rows = _elm_lang$core$List$length(list);
	var maximumWithDefault = function ($default) {
		return function (_p12) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				$default,
				_elm_lang$core$List$maximum(_p12));
		};
	};
	var rowWidth = function (_p13) {
		return A2(
			maximumWithDefault,
			0,
	...
	var cols = A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$map, rowWidth, list)));
	return A3(_user$project$Grid$Grid, cols, rows, list);
};
var _user$project$Grid$padGrid = function (_p14) {
	padGrid:
	while (true) {
		var _p15 = _p14;
		var _p18 = _p15._1;
		...
		if (_elm_lang$core$Native_Utils.eq(
			...
			_p18)) {
			return A3(_user$project$Grid$Grid, _p16, _p18, _p17);
		} else {
			var _v14 = A3(
				_user$project$Grid$Grid,
				_p16,
...
var _user$project$Grid$removeFullRows = function (_p19) {
	var _p20 = _p19;
	var _p22 = _p20._1;
	var _p21 = _p20._0;
	var newGrid = A2(
		...
		_p20._2);
	var removed = _p22 - _elm_lang$core$List$length(newGrid);
	return {
		ctor: '_Tuple2',
		_0: removed,
		_1: _user$project$Grid$padGrid(
			A3(_user$project$Grid$Grid, _p21, _p22, newGrid))
	};
};
var _user$project$Grid$copyOnto = F3(
	function (yOffset, _p24, _p23) {
		var _p25 = _p24;
		var _p28 = _p25._1;
		var _p26 = _p23;
		var _p27 = _p26._2;
		var fromBlockRows = A2(_elm_lang$core$List$drop, yOffset, _p27);
		var belowRows = A2(_elm_lang$core$List$drop, _p28, fromBlockRows);
		var replacedRows = A3(
			_elm_lang$core$List$map2,
			_elm_lang$core$List$append,
			_p25._2,
			A2(_elm_lang$core$List$take, _p28, fromBlockRows));
		var aboveRows = A2(_elm_lang$core$List$take, yOffset, _p27);
		return A3(
			_user$project$Grid$Grid,
			_p26._0,
			_p26._1,
...
var _user$project$Grid$mapCells = F2(
	function (fn, _p29) {
		var _p30 = _p29;
		var mapCellsInRow = function (row) {
			return A2(_elm_lang$core$List$map, fn, row);
		};
		return A3(
			_user$project$Grid$Grid,
			_p30._0,
			_p30._1,
			A2(_elm_lang$core$List$map, mapCellsInRow, _p30._2));
	});
var _user$project$Grid$rotate = function (_p31) {
	var _p32 = _p31;
	var _p35 = _p32._0;
	var maybeMapYToX = F2(
		function (row, _p33) {
			var _p34 = _p33;
			return _elm_lang$core$Native_Utils.eq(row, _p34._0._0) ? _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: _p34._0._1, _1: _p34._1}) : _elm_lang$core$Maybe$Nothing;
		});
	var flattened = _elm_lang$core$List$concat(
		A2(
					...
					return A2(
						...
						function (cell) {
							return {
								...
								_0: {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Tuple$first(cell),
									_1: y
								},
								_1: _elm_lang$core$Tuple$second(cell)
							};
						},
						cellList);
				}),
			_elm_lang$core$List$reverse(_p32._2)));
	var newGrid = A2(
		_elm_lang$core$List$map,
		function (row) {
			return A2(
		...
		A2(_elm_lang$core$List$range, 0, _p35 - 1));
...
var _user$project$Block$makeBlock = F3(
	function (startX, color, thing) {
		var grid = A3(
			_elm_lang$core$Basics$flip,
			_elm_lang$core$List$map,
			thing,
			_elm_lang$core$List$map(
				function (x) {
					return {ctor: '_Tuple2', _0: x, _1: color};
				}));
		return _user$project$Block$Block(
			{
				x: startX,
				y: 0,
				grid: _user$project$Grid$fromListsOfCells(grid)
			});
	});
var _user$project$Block$iBlock = A3(
	_user$project$Block$makeBlock,
	3,
	_elm_lang$core$Color$red,
	{
		ctor: '::',
		_0: A2(_elm_lang$core$List$range, 0, 3),
		_1: {ctor: '[]'}
	});
var _user$project$Block$jBlock = A3(
	_user$project$Block$makeBlock,
	4,
...
var _user$project$Block$lBlock = A3(
	_user$project$Block$makeBlock,
	4,
...
var _user$project$Block$oBlock = A3(
	_user$project$Block$makeBlock,
	5,
...
var _user$project$Block$sBlock = A3(
	_user$project$Block$makeBlock,
	5,
...
var _user$project$Block$tBlock = A3(
	_user$project$Block$makeBlock,
	4,
...
var _user$project$Block$zBlock = A3(
	_user$project$Block$makeBlock,
	5,
...
var _user$project$Block$availableBlocks = {
	ctor: '::',
	_0: _user$project$Block$iBlock,
	_1: {
		ctor: '::',
		_0: _user$project$Block$jBlock,
		_1: {
			ctor: '::',
			_0: _user$project$Block$lBlock,
			_1: {
				ctor: '::',
				_0: _user$project$Block$oBlock,
				_1: {
					ctor: '::',
					_0: _user$project$Block$sBlock,
					_1: {
						ctor: '::',
						_0: _user$project$Block$tBlock,
						_1: {
							ctor: '::',
							_0: _user$project$Block$zBlock,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Block$withoutCollision = F2(
	function (grid, block) {
		return A2(_user$project$Block$detectCollisionInGrid, block, grid) ? _elm_lang$core$Result$Err('Collision occurred') : _elm_lang$core$Result$Ok(block);
	});
var _user$project$Block$validateOnGrid = F2(
	function (grid, block) {
		return A2(
			_elm_lang$core$Result$andThen,
			_user$project$Block$withoutCollision(grid),
			A2(
				_elm_lang$core$Result$andThen,
				_user$project$Block$boardWithinGridWidth(grid),
...
var _user$project$Main$removeFullRows = function (game) {
	...
	var removed = _p7._0;
	var grid = _p7._1;
	var score = A2(_user$project$Main$calculateScore, removed, game.score);
	return {
		ctor: '_Tuple2',
		_0: removed,
		_1: _elm_lang$core$Native_Utils.update(
			game,
			{grid: grid, score: score})
	};
};
...
var _user$project$Main$rowsBetweenLevels = 10;
var _user$project$Main$updateLevel = function (_p9) {
	var _p10 = _p9;
	var _p12 = _p10._1;
	var rowsUntilNextLevel = _p12.rowsToNewLevel - _p10._0;
	var _p11 = (_elm_lang$core$Native_Utils.cmp(rowsUntilNextLevel, 0) < 1) ? {ctor: '_Tuple2', _0: _p12.level + 1, _1: _user$project$Main$rowsBetweenLevels + rowsUntilNextLevel} : {ctor: '_Tuple2', _0: _p12.level, _1: rowsUntilNextLevel};
	var level = _p11._0;
	var rows = _p11._1;
	return _elm_lang$core$Native_Utils.update(
		_p12,
		{level: level, rowsToNewLevel: rows});
};
...
var _user$project$Main$defaultTimeToUpdate = 450 * _elm_lang$core$Time$millisecond;
var _user$project$Main$resetTimeToNextUpdate = function (game) {
	var timeToUpdate = game.boost ? _user$project$Main$boostedTimeToUpdate : (_user$project$Main$defaultTimeToUpdate - (_elm_lang$core$Basics$toFloat(game.level) * 50));
	return _elm_lang$core$Native_Utils.update(
		game,
...
var _user$project$Main$Game = F8(
	function (a, b, c, d, e, f, g, h) {
		return {grid: a, activeBlock: b, nextBlock: c, score: d, timeToUpdate: e, boost: f, level: g, rowsToNewLevel: h};
	});
...
var _user$project$Main$playingNoCmd = F2(
	function (model, game) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
...
var _user$project$Main$startPlaying = F2(
	function (model, _p13) {
		...
		var game = A8(
			...
			grid,
			_p14._0,
			_elm_lang$core$Maybe$Just(_p14._1),
			0,
			_user$project$Main$defaultTimeToUpdate,
			false,
			1,
			_user$project$Main$rowsBetweenLevels);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				state: _user$project$Main$Playing(game)
...
var _user$project$Main$attemptNextBlock = function (game) {
	var _p15 = game.nextBlock;
	if (_p15.ctor === 'Just') {
		var _p16 = _p15._0;
		return A2(_user$project$Block$detectCollisionInGrid, _p16, game.grid) ? A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			...
			_user$project$Main$Playing(
				_elm_lang$core$Native_Utils.update(
					game,
					{activeBlock: _p16, nextBlock: _elm_lang$core$Maybe$Nothing})),
			{
				ctor: '::',
...
var _user$project$Main$landBlock = function (game) {
	return _user$project$Main$attemptNextBlock(
		_user$project$Main$updateLevel(
			_user$project$Main$removeFullRows(
				_user$project$Main$copyBlockToGrid(game))));
};
var _user$project$Main$advanceGame = function (game) {
	var _p17 = A3(_user$project$Block$moveYOn, 1, game.grid, game.activeBlock);
	if (_p17.ctor === 'Ok') {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$Main$Playing(
		...
		case 'Playing':
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$Main$Paused(_p18._0)
					}),
				{ctor: '[]'});
		case 'Paused':
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						state: _user$project$Main$Playing(_p18._0)
					}),
				{ctor: '[]'});
		case 'Initial':
			return A2(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p19 = {ctor: '_Tuple2', _0: msg, _1: model.state};
		_v11_9:
		do {
			if (_p19.ctor === '_Tuple2') {
				switch (_p19._0.ctor) {
					case 'Tick':
						if (_p19._1.ctor === 'Playing') {
							var _p20 = A2(_user$project$Main$updateGame, _p19._1._0, _p19._0._0);
							var updatedGameState = _p20._0;
							var cmd = _p20._1;
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
					...
					case 'Left':
						if (_p19._1.ctor === 'Playing') {
							return A2(
								_user$project$Main$playingNoCmd,
								model,
								A2(
					...
					case 'Rotate':
						if (_p19._1.ctor === 'Playing') {
							return A2(
								_user$project$Main$playingNoCmd,
								model,
								A2(_user$project$Main$modifyActiveBlock, _user$project$Block$rotateOn, _p19._1._0));
						} else {
							break _v11_9;
						}
					case 'Boost':
						if (_p19._1.ctor === 'Playing') {
							return A2(
								_user$project$Main$playingNoCmd,
								model,
								A2(_user$project$Main$setBoost, _p19._0._0, _p19._1._0));
						} else {
							break _v11_9;
						}
					case 'Reset':
					...
					case 'InitialBlocks':
						if (_p19._1.ctor === 'Initial') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								A2(_user$project$Main$startPlaying, model, _p19._0._0),
								{ctor: '[]'});
						} else {
							break _v11_9;
						}
					case 'NextBlock':
						if (_p19._1.ctor === 'Playing') {
							return A2(
								_user$project$Main$playingNoCmd,
								model,
								A2(_user$project$Main$nextBlockSpawned, _p19._1._0, _p19._0._0));
						} else {
							break _v11_9;
						}
					default:
